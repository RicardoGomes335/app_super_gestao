        ...
        <div class="informaacao-pagina">
            ...
            <div style="width: 30%; margin-left: auto; margin-right: auto;">
                <form method="POST" action="{{ route('produto.store') }}">
                    ...
                    <input type="text" name="preco_venda" value="" placeholder="Preço de Venda" class="borda-preta">

                    <input type="text" name="estoque_minimo" value="" placeholder="Estoque minimo" class="borda-preta">
